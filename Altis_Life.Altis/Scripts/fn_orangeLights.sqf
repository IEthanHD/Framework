private ["_veh","_lightyellow","_lightWhite","_lightyellow","_lightsOn","_brightnessHigh","_brightnessLow","_attach","_leftLights","_rightLights","_type","_attenuation"];
...
switch (_type) do
{
    ...
    {
        [false, "yellow", [-0.03, -0, 0.2]] call _attach;
        [true, "yellow", [-0.03, -0, 0.2]] call _attach;
        [false, "yellow", [-0.8, -2.25, -0.3]] call _attach;
